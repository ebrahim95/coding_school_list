...
import { createSignal, onCleanup, getOwner, runWithOwner, createMemo, createContext, useContext, createRenderEffect, untrack, createComponent, on, startTransition, resetErrorBoundaries, children, createRoot, Show, mergeProps, splitProps, sharedConfig, createUniqueId, ErrorBoundary as ErrorBoundary$1, createEffect, createComputed, For, Suspense } from 'solid-js';
import { createTable, getFilteredRowModel, getCoreRowModel, getSortedRowModel, getPaginationRowModel } from '@tanstack/table-core';
...
function About() {
  return ssr(_tmpl$$1, ssrHydrationKey(), escape(createComponent$1(Counter, {})), escape(createComponent$1(A, {
    href: "/",
    "class": "text-sky-600 hover:underline",
    children: "Home"
  })));
...
function Home() {
  ...
  return ssr(_tmpl$2, ssrHydrationKey(), escape(createComponent$1(For, {
    ...
    children: headerGroup => ssr(_tmpl$3, ssrHydrationKey(), escape(createComponent$1(For, {
      get each() {
        return headerGroup.headers;
      },
      children: header => ssr(_tmpl$5, ssrHydrationKey() + ssrAttribute("colspan", escape(header.colSpan, true), false), escape(createComponent$1(Show, {
        get when() {
    ...
    children: row => ssr(_tmpl$3, ssrHydrationKey(), escape(createComponent$1(For, {
      get each() {
